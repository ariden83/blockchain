  ...
  state: {
    ...
    metas: {
      ADA: {
        ...
        logo: require('/static/test/img/ada.png')
      },
      ALGO: {
        name: 'Algorand',
        slug: 'algorand',
        ...
        logo: require('/static/test/img/algo.png')
      },
      BNB: {
        name: 'BNB',
        slug: 'bnb',
        ...
        logo: require('/static/test/img/bnb.png')
      },
      BTT: {
        name: 'BitTorrent',
        slug: 'bittorrent',
        ...
        logo: require('/static/test/img/btt.png')
      },
      BTC: {
        name: 'Bitcoin',
        slug: 'bitcoin',
        ...
        logo: require('/static/test/img/btc.png')
      },
      DOT: {
        name: 'Polkadot',
        slug: 'polkadot',
        ...
        logo: require('/static/test/img/dot.png')
      },
      ETH: {
        name: 'Ethereum',
        slug: 'ethereum',
        ...
        logo: require('/static/test/img/eth.png')
      },
      SOL: {
        name: 'Solana',
        slug: 'solana',
        ...
        logo: require('/static/test/img/sol.png')
      },
      XRP: {
        name: 'Ripple',
        slug: 'ripple',
        ...
        logo: require('/static/test/img/xrp.png')
      }
    },
    units: {
      USDT: 'Tether'
