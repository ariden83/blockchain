...
func writeData(rw *bufio.ReadWriter) {
	...
	// création de nouveaux blocs et nous le diffusons ensuite à notre pair connecté avec rw.WriteString
	for {
		fmt.Print("> ")
...
func main() {
	...
	// listenF ouvre le port auquel nous voulons autoriser les connexions
